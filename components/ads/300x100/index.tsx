...
const AdIframe300x100 = () => {
  ...
  const [iframeId, setIframeId] = useState<string>('af42c904'); // Valor padrão
  const [iframeName, setIframeName] = useState<string>('af42c904'); // Valor padrão
  ...
  const domainConfig: Record<string, { id: string; name: string; zoneid: string }> = {
    ...
    'cornosbrasil.com': { id: 'af42c904', name: 'af42c904', zoneid: '1' },
  ...
  useEffect(() => {
    ...
    let newId = 'af42c904'; // Valor padrão
    let newName = 'af42c904'; // Valor padrão
